...
from .experimental.aio.storage import (
    async_ordered_storage,
    async_unordered_storage,
)

from .lsh import _optimal_param
from .storage import unordered_storage, _random_name
...
class AsyncMinHashLSH(object):
    ...
    :param float threshold: see :class:`.MinHashLSH`.
    :param int num_perm: see :class:`.MinHashLSH`.
    :param weights: see :class:`.MinHashLSH`.
    :type weights: tuple(float, float)
    :param tuple params: see :class:`.MinHashLSH`.
    ...
    .. note::
        ...
        * For main functionality of LSH algorithm see :class:`.MinHashLSH`.
    ...
    def insertion_session(self, batch_size=10000):
        ...
        :return: .experimental.aio.lsh.AsyncMinHashLSHSession

        Example:
            .. code-block:: python

                from .experimental.aio.lsh import AsyncMinHashLSH
