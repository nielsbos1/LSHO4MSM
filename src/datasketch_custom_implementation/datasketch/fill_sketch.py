...
class FillSketch(object):
    ...
    def __init__(
        ...
        # generate hash
        self.hashvalues = self._generate_fill_sketch(input_set=input, sketch_length=sketch_length)
...
if __name__ == "__main__":
    ...
    for j in range(experiments):
        ...
        a = FillSketch(
            input=input_set_a, sketch_length=sketch_length, seeds=[iteration_seed_1, iteration_seed_2], mixed_tab=True
        )
        b = FillSketch(
            input=input_set_b, sketch_length=sketch_length, seeds=[iteration_seed_1, iteration_seed_2], mixed_tab=True
        )
