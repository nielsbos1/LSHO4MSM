...
ax.set_xlim(0, 1)
ax.hist(
    [array_jaccard, array_random_jaccard], bins=25, density=True, label=["True duplicates", "Random selection of pairs"]
)
ax.legend()

plt.savefig(os.path.join(figures_dir, f"jaccard_similarity_of_true_duplicates_versus_random_pairs.png"), dpi=100)
